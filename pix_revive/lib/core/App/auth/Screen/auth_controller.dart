...
import 'package:pix_revive/core/App/auth/Screen/signup_screen.dart';
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Gap(16),
                    Text(text1, style: Kfonts.meduim16),
                    const Gap(8),
                    Text(text2, style: Kfonts.regular16),
                    const Gap(30),
                    BackContiner(
                      child: Row(
                        children: [
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: switcher == Switch.signUp
              ? BorderRadius.only(
        ...
        child: Center(
          child: Text(
            ...
            style: Kfonts.semiBold48.copyWith(
              fontSize: 14,
              color: onTap == null ? Kcolor.mainColor : Kcolor.gray,
            ),
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Kcolor.mainColor.withValues(alpha: 0.3),
            blurRadius: 24,
            offset: Offset(0, 4),
          ),
        ],
      ...
      child: SvgPicture.asset(
        icon,
        colorFilter: ColorFilter.mode(Kcolor.white, BlendMode.srcIn),
      ),
    );
  }
}
